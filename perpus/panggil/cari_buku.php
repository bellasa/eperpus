...
<form method="get"><input type="text" name="cari_buku" placeholder="Cari buku..." value="<?php echo $_GET['cari_buku'];?>"><button type="submit" style="background: none;border: none"><img src="./tampilan/ikon/cari.png" class="crud"></button></form><br>
	<table class="table">
		<tr>
			<th>No</th>
			<th>Tanggal</th>
		...
		<tr>
			...
			<td><a href="./?a=buku&b=ubah&no=<?php echo $buku['no']?>"><img src="./tampilan/ikon/ubah.png" class="crud"></a><a href="#"><img src="./tampilan/ikon/hapus.png" class="crud"></a></td>
		</tr>
		<?php
		}
		?>
