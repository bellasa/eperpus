<div class="container">
<h3>Data Buku | <a href="./?a=buku&b=tambah"><img src="./tampilan/ikon/tambah.png" class="crud"></a></h3>
<form method="get"><input type="text" name="cari_buku" placeholder="Cari buku..."><button type="submit" style="background: none;border: none"><img src="./tampilan/ikon/cari.png" class="crud"></button></form><br>
<?php
...
?>
	<table class="table" style="width:100%" id="buku">
		...
		<tr>
			...
			<td><form method="post"><a href="./?a=buku&b=ubah&no=<?php echo $buku['no']?>"><img src="./tampilan/ikon/ubah.png" class="crud"></a><button value="<?php echo $buku['no']?>" type="submit" style="background:none;border:none;" name="ngapus" onclick="return confirm('Hapus Buku: <?php echo $buku["judul"];?>?')"><img src="./tampilan/ikon/hapus.png" class="crud"></button></form></td>
		</tr>
		<?php
		}
		?>
